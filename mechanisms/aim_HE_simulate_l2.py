...
import argparse
from HE_server import HE_Computations # for FHE
# from HE_server_clear import HE_Computations # for cleartext debugging
...
class AIM(Mechanism):
    ...
    def calculate_max_gaussian_samples(self, domain, workload, rho):
        pass
        return 4096 # this is for testing purpose only
