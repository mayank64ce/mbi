...
if __name__ == "__main__":
    ...
    args.save = f"../data/logs/run_{args.seed}/{dataset_name}_nodp/synth_aim_l1_eps_{args.epsilon}.csv" # data
    model_save_path = f"../data/logs/run_{args.seed}/{dataset_name}_nodp/aim_l1_generator_eps_{args.epsilon}.joblib" # model
    log_dir = f"../data/logs/run_{args.seed}/{dataset_name}_nodp/aim_l1_eps_{args.epsilon}.log"
